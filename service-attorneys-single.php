                    ...
                    <div class="col-md-5">
                        <div class="attorneys-contacts border-card">
                            <div>
                                ...
                                <div>Email: <a href="mailto:ymoshes@mosheslaw.com"> ymoshes@mosheslaw.com</a></div>
                            </div>
                            <div class="content-insideBlock">
                                <h3>AREAS OF PRACTICE</h3>
                                <div>Real Estate Transactions</div>
                            ...
                            <div class="content-insideBlock">
                                <h3>EDUCATION</h3>
                                <div>2005 – 2008, Touro College Jacob D. Fuchsberg Law Center, J.D.</div>
                                <div> 1999 – 2003 City University of New York-Brooklyn College, B.S., Computer Information Science</div>
                            </div>
                        </div>
                    </div>
                </div><!-- /.row -->
