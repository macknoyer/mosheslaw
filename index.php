                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="about-one__content">
                            <p class="about-one__text">We are more than just your typical law firm. Our practice focuses on labor and employment matters such as: Plaintiff-side claims for sexual harassment, discrimination and wage and hour matters. Additionally, our attorneys have a strong background in personal injury, foreclosure defense, short sales and general real estate matters. We are challenging the idea of the traditional law firm that works short hours, charges high upfront retainer fees, and provides a limited level of client service and accessibility</p><!-- /.about-one__text -->
                            <p class="about-one__text">When you turn to the Law Office of Yuriy Moshes, P.C., you are not just getting our legal advice, you are also gaining a friend who will fight tirelessly to ensure that your case has a successful outcome. We consider ourselves to be the champions of our clients’ rights.</p><!-- /.about-one__text -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="fact-one__image">
                            <img src="assets/images/resources/fact-1-2.jpg" alt="Awesome Image" />
                        </div><!-- /.fact-one__image -->
                        <div class="fact-one__box">
                            <i class="fact-one__box-icon opklim-law-1-1"></i>
                            <img class="logo_red_small" src="assets/images/resources/logo_red_small.png" alt="logo_red_small">
            ...
            <div class="container">
                <div class="blog-one__top">
                    ...
                    <div class="blog-one__more-block">
                        <a href="blog-grid.html" class="thm-btn blog-one__more-btn">view all press <i class="fas fa-long-arrow-alt-right"></i></a>
