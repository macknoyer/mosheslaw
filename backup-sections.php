    ...
    <div class="page-wrapper">
                    ...
                    <div class="container clearfix">
                        ...
                        <div class="main-navigation">
                            <ul class=" navigation-box ">
                                ...
                                <li>
                                    <a href="about.html">Personal Injury</a>
                                </li>

                                <li>
                                    <a href="service-1.html">Real Estate</a>
                                </li>
                                ...
                                <li>
                                    <a href="blog-classic.html">Success Stories</a>
                                </li>
                                <li>
                        ...
                        <div class="right-side-box">
                            <!-- <a class="header-phone fixed" href="tel:(888) 445-0234"><span>(888) 445-0234</span></a> -->
        ...
        <section class="cta-one">
            <div class="container text-center">
                <h3 class="cta-one__title">Free Case Evaluation</h3><!-- /.cta-one__title -->
                        ...
                        <div class="item">
                            <div class="testimonials-one__single">
                                <div class="testimonials-container">
                                    <a href="" class="testimonials-logo">
        ...
        <section class="slider-one">
            <div class="slider-one__carousel">
                <div class="item slider-one__slide slider-one__slider-1">
                    <img src="assets/images/slider/loym-main.jpg" alt="" style="position: absolute; z-index: 1">
